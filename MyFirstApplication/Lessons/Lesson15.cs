...
/*
 Enums can be created either withing a class or struct
or in the namespace
 */
public enum Day { Sat, Sun, Mon, Tue, Wed, Thu, Fri };
public enum IceCreamFlavors { Vanilla, Chocolate, Stawberry, RockyRoad };
...
internal class Lesson15
{
    ...
    // Enum using a switch expression to narrow down the choices
    public string FavoriteIceCream(IceCreamFlavors flavors)
    {
        string message = flavors switch
        {
            ...
            IceCreamFlavors.Stawberry => $"My favorite is {IceCreamFlavors.Stawberry}",
